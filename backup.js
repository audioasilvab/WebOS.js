 ...
 self.max &&*/
    ...
    e.hide = function(a) {
        ...
        if (!this.hidden)
            	...
            	this.hidden = true, this.minimize(),
            	

            	this.min = true,
            	this.addClass("hide"),
                setTimeout(() => {
            	//this.g.classList.remove('animate-disappear')
            }, 150);
    }
    ;
    //PENDIENTE
    ...
    e.minimize = function(a) {
        ...
        if (!1 === a)
            return this.restore();
        this.g.classList.add('animate-disappear');
        F && qa();
        this.max && (this.removeClass("max"),
        this.max = !1);
        
        this.min || (this.hide(), //aaaa
        this.g.title = this.title, this.min = true, this.g.classList.add('animate-disappear'),, 
        
        this.focused && setTimeout(() => { (this.blur(), 
        Da()) }, 10),
    ...
    e.maximize = function(a) {
        ...
        F && qa();
        this.min && pa(this);
        this.max || (this.addClass("max").resize(K - this.left - this.right, P - this.top - this.bottom - 50, !0).move(this.left, this.top, !0),
        this.max = !0,
